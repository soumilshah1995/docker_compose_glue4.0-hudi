# docker_compose_glue4.0-hudi
docker_compose_glue4.0 hudi
![Capture (1)](https://github.com/soumilshah1995/docker_compose_glue4.0-hudi/assets/39345855/5cfa222d-fcc0-48aa-9f21-7253ba0c51e1)
...
```
Edit docker file and change this path

    volumes:
      - C:\Users\XXXXXX\.aws:/home/glue_user/.aws
```
...
services:
  jupyter:
    ...
    restart: always
    volumes:
      - C:\Users\s.shah\.aws:/home/glue_user/.aws
...
# Open Jupyter notebook and add this seetings on cell 
```
%%configure -f
{
"conf": {
...
```
# Step 5 : use Sample hudi Script to test it make sure to edit S3 bucket 
```
...
def main():
    ...
    upsert_hudi_table(
        ...
        target_path="s3://XXXX/silver/table_name=sample/",
        spark_df=spark_df,
    )
main()
```
